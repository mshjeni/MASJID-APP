...
<div class="mx-auto" style="width: 800px;">
	...
	<div class="mx-auto" style="width: 800px;">
	<!-- UMRAH FORM -->
	<form class="row g-3" action="AdminUmrahController" method="POST">
		<div class="col-12">
			<label for="slotID" class="form-label">Slot Id</label>    
    		<input type="text" class="form-control" id="slotID" name="slotID" value="<c:out value="${um.slotID}"/>" readonly>   
		</div>
		<div class="col-6">
			<label for="date" class="form-label">Choose Date</label>
			<input type="date" class="form-control" name="date" id="date" value="<c:out value="${um.date}"/>" required>
		</div>
		<div class="col-6">
			<label for="time" class="form-label">Choose Time</label>
			<input type="time" class="form-control" name="time" id="time" value="<c:out value="${um.time}"/>" required>
		</div>
		<div class="col-12">
			<label for="chapter" class="form-label">Chapter</label>
			<input type="text" class="form-control" name="chapter" id="chapter" value="<c:out value="${um.chapter}"/>" required>
		</div>
		<div class="col-12">
			<label for="venue" class="form-label">Venue</label>
			<input type="text" class="form-control" name="venue" id="venue" value="<c:out value="${um.venue}"/>" required>
		</div>
