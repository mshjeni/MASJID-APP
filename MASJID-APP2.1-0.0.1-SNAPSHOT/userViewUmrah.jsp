	...
	<!-- Display Jumaat Slots -->
	  ...
	  <tbody>
	    <tr>
    	  ...
    	  <td><a href="UserBookUmrahController?action=bookUmrah&slotID=<c:out value="${um.slotID}" />" class="btn btn-primary">View Slot</a></td>
	    </tr>
	  </tbody>
	  </c:forEach>
	  
	  <tfoot>
       		<tr><td colspan="4">Available Umrah slots: <script>countItems()</script></td></tr>
    	</tfoot>
		</table>
	  </div><br><br>
	<!-- End Display Umrah Slots -->
