	    ...
	    <table class="table table-borderless" id="totalSlot">
		  ...
		  <tbody>
		    <tr>
		      ...
		      <td><a href="UserBookMengajiController?action=bookMengaji&slotID=<c:out value="${mc.slotID}" />" class="btn btn-primary">View Slot</a></td>
		    </tr>
		  </tbody>
		  </c:forEach>
		  
		  <tfoot>
       		<tr><td colspan="4">Available Mengaji Class slots: <script>countItems()</script></td></tr>
    	</tfoot>
		</table>
	  </div><br><br>
