...
<!-- HEADER -->
	...
	<div class="mx-auto" style="width: 800px;">
	<!-- JUMAAT FORM -->
	<form class="row g-3" action="AdminJumaatController" method="POST">
		<div class="col-12">
			<label for="slotID" class="form-label">Slot Id</label>    
    		<input type="text" class="form-control" id="slotID" name="slotID" value="<c:out value="${jumaatPrayer.slotID}"/>" readonly>   
		</div>
		<div class="col-12">
			<label for="date" class="form-label">Choose Date</label>
			<input type="date" class="form-control" name= "date" id="date"  value="<c:out value="${jumaatPrayer.date}"/>">  
		</div>
		<div class="col-12">
			<label for="khutbahTitle" class="form-label">Khutbah Title</label>
			<input type="text" class="form-control" name="khutbahTitle" id="khutbahTitle" value="<c:out value="${jumaatPrayer.khutbahTitle}"/>">  
		</div>
