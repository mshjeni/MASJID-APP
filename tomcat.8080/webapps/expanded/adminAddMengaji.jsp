...
<body>
	...
	<!-- MENGAJI FORM -->
	<div class="mx-auto" style="width: 800px;">
	<form class="row g-3" action="AddMengajiController" method="POST">
		<div class="col-12">
		...
		<div class="col-12">
			...
			<input type="text" class="form-control" name="guruname" id="guruname" placeholder="Insert Guru Name" required>
		</div>
		<div class="col-12">
