...
<body>
	...
	<br><h2 align="center"><font><strong>Book Mengaji Class Slot</strong></font></h2>
	<br><br><br>
	
	<!-- Create Account  form -->	
	<div class="mx-auto" style="width: 800px;">
	<form class="row g-3" action="UserBookMengajiController" method="POST">
		<div class="col-12">
			<label for="slotID" class="form-label">Slot ID</label>
			<input type="text" class="form-control" name="slotID" id="slotID" value="<c:out value="${mc.slotID}"/>" readonly>
		</div>
		<div class="col-12">
			<label for="date" class="form-label">Date</label>
			<input type="date" class="form-control" name="date" id="date" value="<c:out value="${mc.date}"/>" readonly>
		</div>
		<div class="col-12">
			<label for="khutbahTitle" class="form-label">Khutbah Title</label>
			<input type="text" class="form-control" name="khutbahTitle" id="khutbahTitle" value="<c:out value="${mc.guruname}"/>" readonly>
		</div>
		<div class="col-12">
	...
	<ul class="nav nav-pills nav-fill">
		<li class="nav-item"><a class="nav-link active" aria-current="page" href="UserMengajiController?action=userViewMengaji">Back</a></li>
	</ul><br><br>
	</div>
	<!-- BACK BUTTON -->
</body>
